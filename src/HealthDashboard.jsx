...
const HealthDashboard = () => {
  const sleepData = [
    { day: 'Mon', hours: 5.8, deep: 1.2 },
    { day: 'Tue', hours: 6.2, deep: 1.5 },
    { day: 'Wed', hours: 5.9, deep: 1.3 },
    { day: 'Thu', hours: 6.5, deep: 1.8 },
    { day: 'Fri', hours: 6.1, deep: 1.4 },
    { day: 'Sat', hours: 2.0, deep: 0 },
    { day: 'Sun', hours: 0, deep: 0 },
  ];
              ...
              <CardContent>
                ...
                <ResponsiveContainer width="100%" height={200}>
                  <LineChart data={sleepData}>
                    ...
                    <Line type="monotone" dataKey="deep" stroke="#ef4444" strokeWidth={2} />
                  </LineChart>
                </ResponsiveContainer>
              </CardContent>
            </GradientCard>
